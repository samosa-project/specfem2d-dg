...
!========================================================================
  ...
  integer :: nglob_DG_loc, nglob_acoustic_b_DG
  ...
  allocate(b_dot_rhovz(nglob_acoustic_b_DG))
  allocate(b_dot_E(nglob_acoustic_b_DG))
  allocate(b_rho_DG(nglob_acoustic_b_DG))
  allocate(b_rhovx_DG(nglob_acoustic_b_DG))
  allocate(b_rhovz_DG(nglob_acoustic_b_DG))
  allocate(b_E_DG(nglob_acoustic_b_DG))
  allocate(resu_b_rho(nglob_acoustic_b_DG))
