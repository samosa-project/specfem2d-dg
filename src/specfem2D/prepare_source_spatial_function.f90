            ...
            do j = 1, NGLLZ
              ...
              select case (source_type(i_source))
                case (1)
                  ...
                  else ! Else on SPREAD_SSF_CUSTOM.
                    ! Custom SSF. Add other cases below.
                  ...
                  endif ! Endif on SPREAD_SSF_CUSTOM.
...
subroutine CUSTOM_SSF_MOUNTAIN_WAVE(X, Xs, SSF_out)
  ...
  CPAR1 = 10. ! SIG_X
  CPAR2 = 3. ! SIG_Z
  CPAR3 = 2.*3.14159265358979323846/20. ! K1
