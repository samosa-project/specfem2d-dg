! Source code from http://people.math.sc.edu/Burkardt/f_src/table_delaunay/table_delaunay.html
! Main program was removed, we are only interested in the delaunay triangulation.
