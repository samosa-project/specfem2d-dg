...
!-------------------------------------------------------------------------------
  ...
  write(15,*) MINMOD_FACTOR
  write(15,*) 'CONSTRAIN_HYDROSTATIC'
  write(15,*) CONSTRAIN_HYDROSTATIC
  write(15,*) 'IONOSPHERIC_COUPLING'
  write(15,*) IONOSPHERIC_COUPLING
  ...
  write(15,*) dynamic_viscosity
  write(15,*) 'thermal_conductivity'
  write(15,*) thermal_conductivity
  write(15,*) 'tau_epsilon'
  write(15,*) tau_epsilon
  write(15,*) 'tau_sigma'
  write(15,*) tau_sigma
  write(15,*) 'constant_p'
  ...
  write(15,*) SPREAD_SSF_CUSTOM
  write(15,*) 'CUSTOM_SSF_P00'
  write(15,*) CUSTOM_SSF_P00
  write(15,*) 'CUSTOM_SSF_P01'
  write(15,*) CUSTOM_SSF_P01
