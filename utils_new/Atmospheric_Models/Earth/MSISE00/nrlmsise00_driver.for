C      TEST DRIVER FOR GTD7 (ATMOSPHERIC MODEL)
     ...
     & F107A(15),F107(15),AP(15)    
      ...
      DIMENSION OULOULOUD(9, 10), OULOULOUT(2, 10), OULOULOUALT(10)
      DATA OULOULOUALT/0.,10.,25.,50.,75.,100.,200.,300.,400.,500./
      
      CALL METERS(.TRUE.)
      
      WRITE(6, *) 'ALT HE O N2 O2 AR RHO H N AO EXT T'
      DO I=1,10
        CALL GTD7(0, 43200., OULOULOUALT(I), 0., 0., 12., 150., 150.,
     &            4., 48, OULOULOUD(1, I), OULOULOUT(1, I))
        WRITE(6, *) OULOULOUALT(I), (OULOULOUD(J, I), J=1,9),
     &              (OULOULOUT(J, I), J=1,2)
        WRITE(6, *) ''
      ENDDO
