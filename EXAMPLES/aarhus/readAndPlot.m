...
OFD = [thisFolder,filesep,'OUTPUT_FILES_402141_2090_lns_allatt'];
ITs = [30000, 60000]; do_save = 1;
...
for IT = ITs
  ...
  [fig_field] = plotOneIteration(distMic_Spkr, OFD, IT, boxx, boxy, dx, dz, forceDGMesh, time, pre_t, fac_t, pre_p, fac_p, cax);
