...
specfem2D_OBJECTS = \
	...
	$O/compute_add_sources_acoustic_DG.spec.o \
	...
	$O/compute_forces_NS.spec.o \
	$O/compute_forces_NS_calling_routine.spec.o \
	$O/compute_add_sources_NS.spec.o \
...
cuda_specfem2D_OBJECTS = \
	...
	$O/compute_add_sources_acoustic_DG_cuda.cuda.o \
