...
! main parameter module for specfem simulations
  ...
  ! MODIF DG
  real(kind=CUSTOM_REAL), dimension(:,:,:), allocatable :: gammaext, windxext, windzext, muext, etaext, pext_DG
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: gammaext_DG
  ...
  integer, dimension(:), allocatable :: link_DG_CG
  ...
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: dot_rho, dot_rhovx, dot_rhovz, dot_E
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: rho_DG, rhovx_DG, rhovz_DG, E_DG, &
        veloc_x_DG, veloc_z_DG, p_DG, potential_dphi_dx_DG, potential_dphi_dz_DG, &
        p_DG_init
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: resu_rho, resu_rhovx, resu_rhovz, resu_E      
  !real(kind=CUSTOM_REAL), dimension(:,:), allocatable :: &
  !      dot_rho_rk, dot_rhovx_rk, dot_rhovz_rk, dot_E_rk
  !real(kind=CUSTOM_REAL), dimension(:), allocatable :: &
  !      rho_init_rk, rhovx_init_rk, rhovz_init_rk, E_init_rk
  ...
  ! MODIF NS
  real(kind=CUSTOM_REAL), dimension(:), allocatable :: rmass_inverse_NS
  ...
  ! MODIF DG
  integer, dimension(:,:,:), allocatable :: copy_ibool_ori_bef
  integer, dimension(:), allocatable :: integer_mask_ibool_bef
...
! parameter module for noise simulations
  ...
  logical, dimension(:), allocatable :: data_pixel_recv_ij
  logical, dimension(:), allocatable :: data_pixel_send_ij
  ...
  logical, dimension(:,:), allocatable :: this_ij_image_acous
